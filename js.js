...
//Player
var player={x:160,y:340,height:40,width:35,xSpeed:0,ySpeed:2};
...
function updateGame(){
    ...
    if(enemy.x<0-enemy.width){
        ...
        enemy.height=Math.floor(Math.random()*350)+150;
